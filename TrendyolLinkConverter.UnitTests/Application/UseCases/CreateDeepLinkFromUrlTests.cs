...
namespace TrendyolLinkConverter.UnitTests.Application.UseCases
{
    public class CreateDeepLinkFromUrlTests
    {
        ...
        [Fact]
        public async void CreateDeepLinkFromUrlHandler_InvalidUrl_ShouldBeNull()
        {
        ...
        [Fact]
        public async void CreateDeepLinkFromUrlHandler_InvalidSectionName_ShouldBeNull()
        {
        ...
        [Fact]
        public async void CreateDeepLinkFromUrlHandler_ValidSectionName_ShouldBeNotNull()
        {
